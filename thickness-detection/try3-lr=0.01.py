...
resnet = MobileNetV2(input_shape=IMAGE_SIZE + [3], weights='imagenet', include_top=False)
...
plt.legend()
plt.savefig('try3_loss_lr=0.001.png')
...
plt.savefig('try3_accuracy_lr=0.001.png')
...
plt.savefig("try3_roc_lr=0.001.png")