...
resnet = DenseNet121(input_shape=IMAGE_SIZE + [3], weights='imagenet', include_top=False)
...
plt.legend()
plt.savefig('try3_loss_Dense.png')
...
plt.savefig('try3_accuracy_Dense.png')
...
plt.savefig("try3_roc_Dense.png")